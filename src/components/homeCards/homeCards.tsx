...
const CardSection = () => {
  ...
  return (
    <div className="relative flex flex-col items-center">
      <div className="container mx-auto py-5 sm:py-10 px-4 lg:px-4 relative z-50 ">
        <div>
          <h2 className="text-[#032d60] text-center font-bold text-2xl sm:text-4xl lg:text-4xl  lg:w-8/12 mx-auto mb-14">
            {CardData.heading}
          </h2>
      ...
      {/* <img
        className="absolute scale-125  -bottom-20 -z-50"
        src="/images/Light_Blue.svg"
      /> */}
    </div>
  );
};
